...
const ContactUs = () => {
    ...
    return (
        <>
            ...
            <div className='w-full md:w-3/4 lg:w-[1200px] m-auto flex justify-center items-center mt-8 md:mt-14 px-4'>
                <iframe
                    className='w-full h-64 md:h-80 lg:h-[450px]'
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3533.662849528074!2d85.31829767492158!3d27.665901027319272!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb19000a4f32cf%3A0x53f71813950137ff!2sEvolve%20IT%20Hub%20Nepal!5e0!3m2!1sen!2snp!4v1718008335729!5m2!1sen!2snp"
                    allowFullScreen=""
                    loading="lazy"
            ...
            <div className='w-full md:w-3/4 lg:w-[1200px] m-auto mt-8 md:mt-14 px-4 flex flex-col md:flex-row gap-5 justify-evenly'>
                <div className='w-full md:w-1/3'>
                    <p className='text-2xl md:text-3xl font-medium'>Address</p>
                    <p>Kathmandu, Nepal</p>
                    <p className='text-2xl md:text-3xl font-medium mt-4 md:mt-7'>Phone</p>
                    <p>123456789</p>
                </div>
